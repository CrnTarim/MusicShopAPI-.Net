...
{
    public class UserFavouriteSongMapper:BaseMapper<UserFavouriteSong,UserFavouriteSongDto,UpdateDtoForUserFavouriteSongs,CreationDtoForUserFavouriteSongs>
    {
    }
}
